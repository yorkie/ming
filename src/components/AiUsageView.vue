...
<template>
  <section class="ai-usage">
    ...
    <div v-if="!records.length && !busy && !error" class="ai-usage-empty">{{ t('No AI requests recorded yet. Generate topics in a project to start tracking usage.') }}</div>
